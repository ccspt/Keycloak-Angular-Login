...
export class KeycloakAngularLoginModule {
  static forRoot(configUrl: string, language: string, backend_pati: string, id_app: string): ModuleWithProviders<KeycloakAngularLoginModule> {
    return {
      ngModule: KeycloakAngularLoginModule,
      providers: [
        {
